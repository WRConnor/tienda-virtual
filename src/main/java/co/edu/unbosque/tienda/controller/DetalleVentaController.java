...
import co.edu.unbosque.tienda.service.DetalleVentaService;
...
public class DetalleVentaController {
	...
	public ResponseEntity<String> crear(@RequestBody DetalleVenta c) {
		...
		return new ResponseEntity<String>("Detalle de venta creado con exito", 
				HttpStatus.CREATED);
	}
	...
	ResponseEntity<String> actualizar(Long id,@RequestBody DetalleVenta o){
